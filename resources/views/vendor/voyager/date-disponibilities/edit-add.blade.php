                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control form-select py-3 wd-200" id="villeArrive" data-trigger name="hotel"
                                                    ...
                                                    <option value=""> Nom Hotel <i class="fas fa-ad"></i></option>
                                                    @foreach ($hotels->unique('nom_hotel') as $hotel)
                                                        <option value="{{$hotel->nom_hotel}}">{{$hotel->nom_hotel}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td><input type="date" name="DateDebut" class="form-control"></td>
                                            <td><input type="date" name="DateFin" class="form-control"></td>
                                            <td><input type="text" name="tarif" class="form-control"></td>
