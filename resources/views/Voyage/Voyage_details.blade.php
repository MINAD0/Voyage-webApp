                                    ...
                                    <div class="accordion-body">
                                        <div class="text-muted">
                                            <strong class="text-dark">
                                                ...
                                                @endforeach
                                                    Date Debut: {{date('d-m-Y', strtotime($item->date_debut))}}
                                                    <br>
                                                    Date Fin : {{date('d-m-Y', strtotime($item->date_fin))}}
                                            </strong>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row border p-4 rounded-2 py-2">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr>
                                    <td> <strong>Depart:</strong>  {{date('d-m-Y', strtotime($item->date_debut))}} <strong>Arrive :</strong> {{date('d-m-Y', strtotime($item->date_fin))}}</td>
                                    <td>{{$voyages->Depart}}</td>
                                    <td>{{$voyages->Arrive}}</td>
                                    <td>{{$voyages->prix}} par personne</td>
                                    <td><a href="{{route('paiment')}}" class="btn btn-primary">Réserver maintenant</a></td>
                                </tr>
                        </table>
                    </div>
                </div>
